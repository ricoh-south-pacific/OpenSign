...
async function sendDeclineMail(doc, publicUrl, userId, reason) {
  try {
    ...
    const body =
      ...
      `<div>${logo}</div><div style='padding:2px;font-family:system-ui;background-color:#D7063B'><p style='font-size:20px;font-weight:400;color:white;padding-left:20px'>Document declined by ${signerName}</p>` +
